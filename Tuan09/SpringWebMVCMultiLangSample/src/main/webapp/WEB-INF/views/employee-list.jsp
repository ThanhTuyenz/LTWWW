...
<div class="container">
    <div class="col-md-offset-1 col-12">
        ...
        <span>
            <a href="?lang=en"
               class="<c:if test='${currentLang eq "en"}'>active-lang</c:if>">
               <spring:message code="label.lang.en"/>
            </a>&nbsp;&nbsp;&nbsp;

            <a href="?lang=vi"
               class="<c:if test='${currentLang eq "vi"}'>active-lang</c:if>">
               <spring:message code="label.lang.vi"/>
            </a>
        </span>
        <h3 class="text-center"><spring:message code="label.employee.list.title"></spring:message></h3>
        <hr/>
            ...
            <div class="panel-body">
                <table class="table table-striped table-bordered">
                    ...
                    <c:forEach var="employee" items="${employees}">
                        ...
                        <!-- construct a "update" link with employee id -->
                            ...
                            <c:forEach var="i" begin="1" end="${totalPages}">
                                ...
                                <c:choose>
                                    <c:when test="${currentPage != i}">
                                        <li class="page-item">
                                            <a class="page-link"
                                               href="<c:url value='/employees/page/${i}?sortBy=${sortBy}&sortDirection=${sortDirection}' />">${i}</a>
                                        </li>
                                    </c:when>
                                    <c:when test="${currentPage == i}">
